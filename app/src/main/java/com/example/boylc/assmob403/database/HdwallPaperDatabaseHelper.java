...
public class HdwallPaperDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void addOrUpdateWallPaper(HDWALLPAPER hdwallpaper) {
        ...
        try {
            ...
            int rows = db.update(TABLE_WALLPAPERS, values, KEY_WALLPAPER_ID + "= ?", new String[]{hdwallpaper.getId()});
...
//                    values.put(KEY_WALLPAPER_CATEGORY_IMAGE_THUMB, hdwallpaper.getCategoryImageThumb());
                    ...
                    hdwallpaper.setWallpaperImageThumb(cursor.getString(cursor.getColumnIndex(KEY_WALLPAPER_IMAGE_THUMB)));
                    ...
                    hdwallpaper.setCategoryImage(cursor.getString(cursor.getColumnIndex(KEY_WALLPAPER_CATEGORY_IMAGE)));
                    hdwallpaper.setCategoryImageThumb(cursor.getString(cursor.getColumnIndex(KEY_WALLPAPER_CATEGORY_IMAGE_THUMB)));
